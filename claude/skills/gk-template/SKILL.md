...
- **Recommend only installed capabilities.** Derive recommendation metadata solely from agents/skills/tools/MCP servers actually discovered in the active Claude Code installation, or explicitly marked `install required`.

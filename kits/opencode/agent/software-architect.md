...
1. Understand the business domain and constraints
2. Identify bounded contexts and aggregate boundaries
3. Select architecture pattern based on trade-off analysis
4. Document decisions as ADRs
5. Verify dependency direction and boundary rules
6. Review quality attributes against requirements

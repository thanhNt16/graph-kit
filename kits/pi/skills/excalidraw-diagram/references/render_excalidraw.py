...
Usage:
    cd .omp/skills/excalidraw-diagram/references
...
def render(
    ...
    try:
        ...
        print("Run: cd .omp/skills/excalidraw-diagram/references && uv sync && uv run playwright install chromium", file=sys.stderr)
        sys.exit(1)
